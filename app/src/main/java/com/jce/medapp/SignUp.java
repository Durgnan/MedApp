...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> list = Arrays.asList(getResources().getStringArray(R.array.bg));
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isAlreadyPresent(email))
                {
                    ...
                    registerObject.put("type", "user");
                    registerObject.put("BG",bloodGrp);
                    ...
                    ParseObject registerLocation = new ParseObject("UserLocation");
                    registerLocation.put("Username", email);
                    registerLocation.put("Location", new ParseGeoPoint(0,0));
                    registerLocation.saveInBackground(new SaveCallback() {
                        @Override
                        public void done(ParseException e) {
                            if (e != null)
                                Log.e("ERROR", e.getMessage());
