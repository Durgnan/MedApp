        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isAlreadyPresent(email))
                {
                    ...
                    registerObject.put("type", "ambulance");
                    ...
                    ParseObject registerObject1 = new ParseObject("DriverLocation");
                    registerObject1.put("userId", email);
                    registerObject1.put("Location", new ParseGeoPoint(0,0));
                    registerObject1.saveInBackground(new SaveCallback() {
                        @Override
                        public void done(ParseException e) {
                            // Here you can handle errors, if thrown. Otherwise, "e" should be null
                            if (e != null)
                                ...
                                Intent intent = new Intent(AddAmbulance.this, Admin.class);
